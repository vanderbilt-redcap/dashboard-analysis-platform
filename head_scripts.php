...
<script type="text/javascript" src="<?=$module->getUrl('js/clipboard.js')?>"></script>
<script type="text/javascript" src="<?=$module->getUrl('js/jquery_tablednd.js')?>"></script>
<script type="text/javascript" src="<?=$module->getUrl('js/DataExport.js')?>"></script>
<script type="text/javascript" src="<?=$module->getUrl('js/ReportView.js')?>"></script>
...
<link type='text/css' href='<?=$module->getUrl('css/report.css')?>' rel='stylesheet' media='screen' />
