    ...
    public static function createQuestion_1($module, $project_id, $multipleRecords, $institutions, $table_data, $recordIds)
    {
        ...
        foreach ($array_study_1 as $study => $label) {
            ...
            foreach ($row_questions_1 as $indexQuestion => $question_1) {
                ...
                #OVERALL COL MISSING
                $totalCol = \Vanderbilt\DashboardAnalysisPlatformExternalModule\getTotalCol($question, $project_id, $question_1, $conditionDate, $topScoreMax, $indexQuestion, $missing_col, $tooltipTextArray, $array_colors,$institutions, $recordIds);
